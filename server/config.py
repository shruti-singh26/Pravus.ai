...
LLM_PROVIDER = os.environ.get('LLM_PROVIDER', 'openai').lower()  # 'openai' or 'deepseek'
...
DEFAULT_LLM_MODEL = OPENAI_CHAT_MODEL if LLM_PROVIDER == 'openai' else DEEPSEEK_MODEL
